...
$apiEndpoint = "https://sheets.googleapis.com/v4/spreadsheets/".CF8::parse(trim($action['sheet_id']))."/values/Sheet1!".CF8::parse(trim($action['range'])).":".CF8::parse(trim($action['method']))."?valueInputOption=USER_ENTERED";
