...
ck2=Choice #2
ck3=Choice #3", rows:5, hint:"Multiline list of options, may use the format value=Text"); ?>
<?php
$behaviors = ["validation_required", "validation_function", "validation_count", "hint", "field_class", "html_attributes", "dynamic_options", "events_triggers", "events_listeners", "selected_values"];
