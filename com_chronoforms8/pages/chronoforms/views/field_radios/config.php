...
<?php
$behaviors = ["validation_required", "validation_function", "hint", "field_class", "html_attributes", "fields_layout", "dynamic_options", "events_triggers", "events_listeners", "selected_values"];
